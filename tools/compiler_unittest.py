...
class CompileFilterStatementTests(unittest.TestCase):
    ...
    def test_trap(self):
        """Accept lines that traps unconditionally."""
    ...
    def test_trace(self):
        """Accept lines that traces unconditionally."""
    ...
    def test_log(self):
        """Accept lines that logs unconditionally."""
...
class CompileFileTests(unittest.TestCase):
    ...
    def test_compile_huge_policy(self):
        ...
        # Given that the BST strategy is O(n³), don't choose a crazy large
